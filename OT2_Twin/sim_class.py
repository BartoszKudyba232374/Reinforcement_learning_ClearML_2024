...
class Simulation:
    def __init__(self, num_agents, render=True, rgb_array=False):
        ...
        self.plate_image_path = os.path.join(os.path.dirname(__file__), f'textures/_plates/{os.listdir(os.path.join(os.path.dirname(__file__),"textures/_plates"))[random_texture_index]}')
        self.textureId = p.loadTexture(os.path.join(os.path.dirname(__file__),f'textures/{random_texture}'))
        ...
        for i in range(grid_size):
            for j in range(grid_size):
                if agent_count < num_agents:  # Check if more agents need to be placed
                    ...
                    robotId = p.loadURDF(os.path.join(os.path.dirname(__file__),"ot_2_simulation_v6.urdf"), position, [0,0,0,1],
                    ...
                    planeId = p.loadURDF(os.path.join(os.path.dirname(__file__),"custom.urdf"), position_with_offset, rotate_90)#start_orientation)
